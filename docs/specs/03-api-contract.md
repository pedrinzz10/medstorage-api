...
GET    /api/inventory/movements           → histórico paginado de movimentos IN/OUT     → 200       ✅ implementado
GET    /api/inventory/movements?productId → movimentos filtrados por produto            → 200       ✅ implementado
```
