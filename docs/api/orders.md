...
Falha no envio (ex.: credenciais SMTP inválidas/ausentes) é capturada e logada como warning — **nunca bloqueia ou desfaz** a transição de status, conforme `docs/specs/04-business-rules.md` regra 4. Não há fila de retry automática nesta sprint (ver `docs/ferramentas/smtp-gmail.md`).
