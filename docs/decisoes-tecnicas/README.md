...
Cada decisão relevante de arquitetura/ferramenta é registrada em um arquivo numerado, no formato:
...
## Índice
- [0001-ferramenta-de-migration.md](0001-ferramenta-de-migration.md) — Flyway para versionamento de schema
